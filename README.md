...
| [`wip-github`](./skills/wip-github) | One-screen readout of all GitHub work you have open across every repo you and Claude can reach: your PRs (draft/ready with merge, CI, review state), PRs awaiting your review, branches with no PR, issues you opened, and repos Claude cannot see. Deterministic script, two lines of interpretation. | `npx skills add snowpackdata/snowpack-claude-skills --skill wip-github` — see its [`SKILL.md`](./skills/wip-github/SKILL.md) |
